                ...
                <div className="subject" id="subject3">
                    ...
                    <div className="container-contact">
                        ...
                        <a href="https://github.com/quentinmay">
                            <h3 className="contact-info github paragraph" href="https://github.com/quentinmay"><GoMarkGithub /> quentinmay</h3>
                        </a>
                        <a href="https://www.linkedin.com/in/quentin-may-7b28a8213/">
                            <h3 className="contact-info linked-in paragraph"><AiFillLinkedin /> quentinemay@gmail.com</h3>
                        </a>
                    </div>
                </div>
